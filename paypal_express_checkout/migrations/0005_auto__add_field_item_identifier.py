...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.identifier'
        db.add_column('paypal_express_checkout_item', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.identifier'
        db.delete_column('paypal_express_checkout_item', 'identifier')
